...
echo "\033[36;1m\n\t TEST -e \033[0m"
grep -e GOT 1_g.txt > orig.txt
./s21_grep -e GOT 1_g.txt > ne_orig.txt
if diff orig.txt ne_orig.txt ; then
 echo "\033[32;1m\t OK\n\033[0m"
else
 echo "\033[31;1m\t FAIL\n\033[0m"
...
echo "\033[36;1m\n\t TEST -f \033[0m"
grep -f 3_g.txt 1_g.txt > orig.txt
./s21_grep -f 3_g.txt 1_g.txt > ne_orig.txt
if diff orig.txt ne_orig.txt ; then
 echo "\033[32;1m\t OK\n\033[0m"
else
 echo "\033[31;1m\t FAIL\n\033[0m"
...
echo "\033[36;1m\n\t TEST -s \033[0m"
grep -s tut oshibok.net > orig.txt
./s21_grep -s tut oshibok.net > ne_orig.txt
if diff orig.txt ne_orig.txt ; then
 echo "\033[32;1m\t OK\n\033[0m"
else
 echo "\033[31;1m\t FAIL\n\033[0m"
...
grep grep -s 123123 > orig.txt
./s21_grep grep -s 123123 > ne_orig.txt
if diff orig.txt ne_orig.txt ; then
 echo "\033[32;1m\t OK\n\033[0m"
else
 echo "\033[31;1m\t FAIL\n\033[0m"
