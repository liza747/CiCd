## Разработка простого **CI/CD** для проекта *Bash Utils*. Сборка, тестирование, развертывание.
...
В результате вы должны получить готовые к работе приложения из проекта *BashScripts* (cat и grep) на второй виртуальной машине.
...
##### Настроить уведомления о успешном/неуспешном выполнении пайплайна через бота с именем "[ваш nickname] CI/CD" в *Telegramm*
